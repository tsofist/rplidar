...
class RPLidarDriverBase extends events_1.EventEmitter {
    ...
    async scanStart(forceMode = false) {
        ...
        await this.writeCommand(Command.Scan, [consts_1$1.CommandStartByte, forceMode ? 0x21 : 0x20], async (descriptor) => {
            ...
            let finishStreaming;
            (0, tslib_1$1.__classPrivateFieldSet)(this, _RPLidarDriverBase_streaming, new Promise((resolve) => {
                finishStreaming = resolve;
            }), "f");
            const done = () => {
                (0, tslib_1$1.__classPrivateFieldSet)(this, _RPLidarDriverBase_streaming, undefined, "f");
    ...
    async scanStop() {
        await this.writeCommand(Command.Stop, [consts_1$1.CommandStartByte, 0x25], async () => {
            ...
            await (0, tslib_1$1.__classPrivateFieldGet)(this, _RPLidarDriverBase_streaming, "f");
            this.resetScanning();
        });
    }
    async listScanModes() {
    ...
    resetScanning() {
        if (this.scanning || (0, tslib_1$1.__classPrivateFieldGet)(this, _RPLidarDriverBase_streaming, "f")) {
            (0, tslib_1$1.__classPrivateFieldSet)(this, _RPLidarDriverBase_streaming, undefined, "f");
            (0, tslib_1$1.__classPrivateFieldSet)(this, _RPLidarDriverBase_scanning, false, "f");
...
var RPLidarBrowser_1 = browser.RPLidarBrowser = void 0;
...
RPLidarBrowser_1 = browser.RPLidarBrowser = RPLidarBrowser;
...
export { RPLidarBrowser_1 as RPLidarBrowser, browser as default };
